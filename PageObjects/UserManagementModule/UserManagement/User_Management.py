...
class UserManagement(BaseClass):
    ...
    def user_navigation(self):
        self.verify_element_present_bytext('User Management', 30)
        self.click_element_bytext('User Management')
        self.verify_element_present_bytext('Add User', 20)
        self.click_button_bytext('Add User')
        self.verify_element_present_bytext('Add New User', 20)
        status = self.verify_element_present_bytext('Add New User',30)
        assert status == True

    def verify_edit_button_in_table(self):
        self.verify_element_present_bytext('User Management', 20)
        self.click_element_bytext('User Management')
    ...
    def set_password(self, question1, question2, answer1, answer2, password):
        ...
        self.click_element_bytext('Save')
    ...
    def add_user(self, role, firstname, lastname, email, question1, question2, answer1, answer2, password):
        ...
        time.sleep(.5)
        self.click_element_bytext('User Management')
        self.button_visible_bytext('Add User')
        self.click_button_bytext('Add User')
        ...
        self.click_button_bytext('Continue')
        time.sleep(5)
        self.click_button_bytext('Confirm')
    ...
    def edit_user(self, username, newFirstName, newLastName):
        ...
        self.click_button_bytext('Save & Next')
    ...
    def view_user(self, username, accountStatus, Status, userRole):
        log = self.get_logger()
        self.verify_element_present_bytext('Configuration', 20)
        self.click_element_bytext('Configuration')
        time.sleep(2)
        self.click_element_bytext('User Management')
        self.verify_element_present(self.SEARCH_HERE, 20)
        self.send_Keys(self.SEARCH_HERE, username)
    ...
    def forgot_password(self, email):
        ...
        self.button_visible_bytext('Submit')
        self.click_element_bytext('Submit')
